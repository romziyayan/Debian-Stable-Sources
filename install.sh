...
sudo apt update
sudo apt install htop btop git curl wget fastfetch screen tmux tasksel traceroute apache2 apache2-doc mariadb-server mariadb-client php libapache2-mod-php php-mysql lsb-release locales python3 python3-pip python3-venv python3-dev python3-full pipx nodejs npm -y
